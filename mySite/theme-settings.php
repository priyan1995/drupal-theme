...
/**
 * @file
 * Custom setting for mytheme theme.
 */
function mytheme_form_system_theme_settings_alter(&$form, FormStateInterface &$form_state, $form_id = NULL) {
  $img_path = $GLOBALS['base_url'] . '/' . drupal_get_path('theme', 'mytheme') . '/images/mythemepro.jpg';
  $img = '<img src="'.$img_path.'" alt="image" />';
  $form['mytheme'] = [
    '#type'       => 'vertical_tabs',
    '#title'      => '<h3>' . t('mytheme Theme Settings') . '</h3>',
    '#default_tab' => 'general',
  ];
  ...
  $form['general'] = [
    '#type'  => 'details',
    '#title' => t('General'),
    '#description' => t('<h3>Thanks for using mytheme Theme</h3>mytheme is a free Drupal 8 theme designed and developed by <a href="https://drupar.com" target="_blank">Drupar.com</a>'),
    '#group' => 'mytheme',
  ];
  ...
  // Upgrade to mythemepro tab.
  $form['upgrade'] = [
    '#type'  => 'details',
    '#title' => t('Upgrade to mythemePro'),
    '#description'  => t('<h3>Upgrade To mythemePro For $19 Only.</h3>'),
    '#group' => 'mytheme',
  ];
  ...
  $form['general']['general_info'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Theme Info'),
    '#description' => t('<a href="https://www.drupar.com/theme/mytheme" target="_blank">Theme Homepage</a> || <a href="//demo2.drupar.com/mytheme/" target="_blank">Theme Demo</a> || <a href="https://www.drupar.com/mytheme-theme-documentation" target="_blank">Theme Documentation</a> || <a href="https://www.drupar.com/support" target="_blank">Theme Support</a>'),
  ];

  $form['general']['general_info_upgrade'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Upgrade To mythemePro for $19 only'),
    '#description' => t('<a href="https://www.drupar.com/theme/mythemepro" target="_blank">Purchase mythemePro</a> || <a href="//demo2.drupar.com/mythemepro/" target="_blank">mythemePro Demo</a>'),
  ];
  ...
  $form['color']['theme_color'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Theme Color'),
    '#description'   => t('This feature is available in the premium version of this theme. <a href="https://www.drupar.com/theme/mythemepro" target="_blank">Buy mythemePro for $19 only.</a>'),
  ];
  ...
  $form['social']['all_icons']['all_icons_show'] = [
    ...
    '#default_value' => theme_get_setting('all_icons_show', 'mytheme'),
  ...
  $form['social']['facebook']['facebook_url'] = [
    ...
    '#default_value' => theme_get_setting('facebook_url', 'mytheme'),
  ];
  ...
  $form['social']['twitter']['twitter_url'] = [
    ...
    '#default_value' => theme_get_setting('twitter_url', 'mytheme'),
  ];
  ...
  $form['social']['instagram']['instagram_url'] = [
    ...
    '#default_value' => theme_get_setting('instagram_url', 'mytheme'),
  ];
  ...
  $form['social']['linkedin']['linkedin_url'] = [
    ...
    '#default_value' => theme_get_setting('linkedin_url', 'mytheme'),
  ];
  ...
  $form['social']['youtube']['youtube_url'] = [
    ...
    '#default_value' => theme_get_setting('youtube_url', 'mytheme'),
  ];
  ...
  $form['social']['vimeo']['vimeo_url'] = [
    ...
    '#default_value' => theme_get_setting('vimeo_url', 'mytheme'),
  ];
  ...
  // Social -> vk.com url.
   ...
   $form['social']['vk']['vk_url'] = [
       ...
       '#default_value' => theme_get_setting('vk_url', 'mytheme'),
   ];
   ...
   $form['social']['whatsapp']['whatsapp_url'] = [
       ...
       '#default_value' => theme_get_setting('whatsapp_url', 'mytheme'),
   ];
   ...
   $form['social']['github']['github_url'] = [
       ...
       '#default_value' => theme_get_setting('github_url', 'mytheme'),
   ];
   ...
   $form['social']['telegram']['telegram_url'] = [
     ...
     '#default_value' => theme_get_setting('telegram_url', 'mytheme'),
   ];
  ...
  $form['slider']['slider_enable_option']['slider_show'] = [
    ...
    '#default_value' => theme_get_setting('slider_show', 'mytheme'),
  ...
  $form['slider']['slider_image_section']['slider_image'] = [
    ...
    '#default_value'  => theme_get_setting('slider_image', 'mytheme'),
    '#description'   => t('mytheme theme has limitation of single image for slider. Separate image for each slide is available in mythemePro. <a href="https://www.drupar.com/theme/mythemepro" target="_blank">Buy mythemePro for $19 only.</a>'),
  ];
  ...
  $form['slider']['slider_time_field']['slider_time'] = [
    '#type'          => 'number',
    '#default_value' => theme_get_setting('slider_time', 'mytheme'),
  ...
  $form['slider']['slider_dots_field']['slider_dots'] = [
    ...
    '#options' => array(
      'true' => t('Show'),
      'false' => t('Hide'),),
    '#default_value' => theme_get_setting('slider_dots', 'mytheme'),
  ...
  $form['slider']['slider_code'] = [
    '#type'          => 'textarea',
    '#title'         => t('Slider Code'),
    '#default_value' => theme_get_setting('slider_code', 'mytheme'),
    '#description'   => t('Please refer to this <a href="https://www.drupar.com/mytheme-theme-documentation/how-manage-homepage-slider" target="_blank">documentation page</a> for slider code tutorial.'),
  ];
  ...
  $form['sidebar']['front_sidebars']['front_sidebar'] = [
    ...
    '#default_value' => theme_get_setting('front_sidebar', 'mytheme'),
  ...
  $form['content']['homepage'] = [
    ...
    '#description'   => t('Please follow this tutorial to add content on homepage. <a href="https://www.drupar.com/mytheme-theme-documentation/how-add-content-homepage" target="_blank">How to add content on homepage</a>'),
  ];
  ...
  $form['content']['google_font_section']['google_font'] = [
    ...
    '#default_value' => theme_get_setting('google_font', 'mytheme'),
    '#description'   => t('mytheme theme uses following Google fonts: Open Sans, Roboto and Poppins. You can serve these fonts locally or from Google server.'),
  ];
  ...
  $form['content']['fonticons']['font_icons'] = [
    ...
    '#description'   => t('mytheme theme has included FontAwesome v4.7 font icons. You can use 600+ icons with mytheme theme.<br />Please visit this tutorial page for details. <a href="https://www.drupar.com/custom-shortcodes-set-two/fontawesome-font-icons" target="_blank">How To Use FontAwesome Icons</a>.'),
  ];
  ...
  $form['content']['shortcodes'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Shortcodes'),
    '#description'   => t('mytheme theme has some custom shortcodes. You can create some styling content using these shortcodes.<br />Please visit this tutorial page for details. <a href="https://www.drupar.com/mytheme-theme-documentation/mytheme-shortcodes" target="_blank">Shortcodes in mytheme theme</a>.'),
  ];
  ...
  $form['content']['comment']['comment_user_pic'] = [
    ...
    '#default_value' => theme_get_setting('comment_user_pic', 'mytheme'),
  ...
  $form['content']['node']['node_author_pic'] = [
    ...
    '#default_value' => theme_get_setting('node_author_pic', 'mytheme'),
  ...
  $form['content']['node']['node_tags'] = [
    '#type'          => 'checkbox',
    '#title'         => t('Node Tags'),
    '#default_value' => theme_get_setting('node_tags', 'mytheme'),
  ...
  $form['footer']['scrolltotop']['scrolltotop_on'] = [
    ...
    '#default_value' => theme_get_setting('scrolltotop_on', 'mytheme'),
  ...
  $form['footer']['copyright']['copyright_text'] = [
    ...
    '#default_value' => theme_get_setting('copyright_text', 'mytheme'),
  ...
  $form['insert_codes']['css']['css_custom']['css_extra'] = [
    ...
    '#default_value' => theme_get_setting('css_extra', 'mytheme'),
  ...
  $form['insert_codes']['css']['css_code'] = [
    ...
    '#default_value' => theme_get_setting('css_code', 'mytheme'),
    '#description'   => t('Add your own CSS codes here to customize the appearance of your site.<br />Please refer to this tutorial for detail: <a href="https://www.drupar.com/mytheme-theme-documentation/custom-css" target="_blank">Custom CSS</a>'),
  ];
  ...
  $form['support']['info'] = [
    ...
    <p>We have a detailed documentation about how to use theme. Please read the <a href="https://www.drupar.com/mytheme-theme-documentation" target="_blank">mytheme Theme Documentation</a>.</p>
    <hr />
    <h4>Open An Issue</h4>
    <p>If you need support that is beyond our theme documentation, please <a href="https://www.drupal.org/project/issues/mytheme?categories=All" target="_blank">open an issue</a> at project page.</p>
    <hr />
    <h4>Contact Us</h4>
  ...
  $form['upgrade']['info'] = [
    '#type'        => 'fieldset',
    '#title'       => t('<a href="https://demo2.drupar.com/mythemepro/" target="_blank">mythemePro Demo</a> | <a href="https://www.drupar.com/theme/mythemepro" target="_blank">Purchase mythemePro for $19 only</a>'),
    '#description' => t("$img<br /><a href='https://demo2.drupar.com/mythemepro/' target='_blank'>mythemePro Demo</a> | <a href='https://www.drupar.com/theme/mythemepro' target='_blank'>Purchase mythemePro for $19 only</a>"),
  ];
// End form.
}
